...
export default function Home() {
  ...
  const [modal, setModal] = useState<
    "pay" | "bank" | "qr" | "scan" | "property" | "card" | "admin" | null
  >(null);
  ...
  useEffect(() => {
    const raw = localStorage.getItem("monopoly-session");
  ...
  const enter = (s: Session) => {
    localStorage.setItem("monopoly-session", JSON.stringify(s));
    setSession(s);
  };
  ...
  function leave() {
    localStorage.removeItem("monopoly-session");
    setSession(null);
    setGame(null);
    setMode("home");
  }
  async function downloadBoard() {
    ...
    try {
      ...
      link.download = `papan-monopoly-${game?.room.code || "custom"}.png`;
      link.href = dataUrl;
      link.click();
        ...
        await instance.start(
          ...
          async (text) => {
            try {
              ...
              if (
                payload.kind !== "monopoly-payment" ||
                payload.room !== session?.roomCode
              )
      ...
      <main className="landing">
        ...
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow">PENDAMPING PAPAN MONOPOLY</p>
            <h1>
      ...
      <div className="game-layout">
        ...
        <aside className="side-column">
          <section className="panel">
            ...
            {isHost && (
              <button className="panel-cta" onClick={() => setModal("bank")}>
                Kelola bank
              </button>
            )}
          </section>
          <section className="bank-card">
            <div>
              <p className="eyebrow">BANK MONOPOLY</p>
        ...
        <div className="modal-backdrop" onMouseDown={() => setModal(null)}>
          ...
          >
            ...
            {modal === "admin" ? (
                ...
                {adminTab === "board" && (
                  <div className="board-export">
                    <div className="board-export-actions">
                      <div>
                        <b>Layout papan siap cetak</b>
                        <small>
                          Mengikuti nama, warna, tipe petak, dan harga properti
                          saat ini.
                        </small>
                      </div>
                      <button
                    ...
                    <div className="print-board-wrap">
                      <div className="print-board" ref={boardRef}>
                        <div className="print-board-center">
                          <span>MONOPOLY</span>
                          <b>DIGITAL</b>
                          <small>Ruang {game.room.code} • Uang permainan</small>
                        ...
                        {game.spaces.map((s) => {
                          ...
                          return (
                            <div
                              key={s.id}
                              className={`print-space board-pos-${s.position}`}
                              style={
                                {
                            ...
                            >
                              ...
                              <em>
                                {p
                                  ? `${rupiah(p.price)} • sewa ${rupiah(p.rent)}`
                                  : s.type.replaceAll("_", " ")}
                              </em>
                            </div>
                          );
                    ...
                    <p className="board-hint">
                      PNG dibuat 3× lebih besar agar tetap tajam saat dicetak.
                      Untuk PDF, buka gambar lalu pilih Print → Save as PDF.
                    </p>
                  </div>
                )}
              </div>
              ...
              <>
                <p className="eyebrow">SCAN PEMBAYARAN</p>
                <h2>Arahkan kamera ke QR pemain</h2>
                <div id="qr-reader" className="qr-reader" />
                <p className="qr-note">
                  Izinkan akses kamera saat diminta. Kamera hanya membaca QR
                  internal Monopoly pada ruang yang sama.
                </p>
              </>
            ) : modal === "property" ? (
              <>
